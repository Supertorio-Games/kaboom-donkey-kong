...
export default () => {
  ...
  // Audio Files
  k.loadSound("die", "audio/dk-a2600_die.ogg");
  k.loadSound("jump", "audio/dk-a2600_jump.ogg");
  k.loadSound("over", "audio/dk-a2600_over.ogg");
  k.loadSound("victory", "audio/dk-a2600_victory.ogg");
  k.loadSound("walk", "audio/dk-a2600_walk.ogg");
};
